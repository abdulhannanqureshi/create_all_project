...
class PrivayPolicy extends Component<IAddBlogProps, IAddBlogState> {
            ...
            <Card>
              <Card.Header>
                <h4>
                  ...
                  &nbsp;{!isEditable ? "Add" : "Update"} Privacy Policy
                </h4>
              </Card.Header>
              <Card.Body>
                <div className="row">
...
export default connect(mapStateToProps, mapDispatchToProps)(PrivayPolicy);
